    ...
    <div class="card">
        <table class="table card-table table-striped table-bordered datatable">
            ...
            <?php $__currentLoopData = $query->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x => $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $__currentLoopData = $client->deposits()->where('status','approved')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x => $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
...
<?php echo $__env->make( 'layouts.reports', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paulsclub/public_html/arbitrage-trading.io/resources/views/reports/finance/approval_deposits.blade.php ENDPATH**/ ?>