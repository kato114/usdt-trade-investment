                    ...
                    <tr>
                        <td><i><?php echo e($x+1); ?></i></td>
                              ...
                              <td><button class="myBtn1"  id="myBtn<?php echo e($client->id); ?>">Open Modal</button></td>
                               <span style="
    display: none;
" id="hiddentextmyBtn<?php echo e($client->id); ?>"><?php urldecode($client->data) ?></span>
...
<?php echo $__env->make( 'layouts.reports', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paulsclub/public_html/arbitrage-trading.io/resources/views/reports/finance/operation_data.blade.php ENDPATH**/ ?>