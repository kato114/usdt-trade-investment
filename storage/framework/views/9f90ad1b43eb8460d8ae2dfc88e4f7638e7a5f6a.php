...
">
        ...
        <div class="card-options">
           ...
           <div class="btnWraper">
            ...
            <div class="btnWraper">
                <a class="btn btn-success mr-4" href="<?php echo e(route('client', ['client' => $client, 'action' => 'wallet'])); ?>">Deposit</a>
                <a class="btn btn-primary mr-4" href="<?php echo e(route('client', ['client' => $client, 'action' => 'wallet'])); ?>">Withdraw</a>
                </div>
                   <?php endif; ?>
            <?php endif; ?>
        </div>
...
<?php /**PATH E:\xampp\htdocs\25-percent\resources\views/client/account.blade.php ENDPATH**/ ?>