            ...
            <div class="card-tabs cusTabs">
                ...
                <ul class="nav nav-tabs mx-0">
                    <li class="nav-item">
                        <a data-turbolinks="false"
                           ...
                           class="nav-link <?php if(request('action') == 'dashboard'): ?> active <?php endif; ?>">Dashboard</a>
                              ...
                              <li class="nav-item">
                        <a data-turbolinks="false"
                           href="<?php echo e(route('client', ['client' => $client, 'action' => 'overview'])); ?>"
                           class="nav-link <?php if(request('action') == 'overview'): ?> active <?php endif; ?>">Overview</a>
                    </li>
                 ...
                 <?php endif; ?>
                    <li class="nav-item">
                        <a data-turbolinks="false"
                           href="<?php echo e(route('client', ['client' => $client, 'action' => 'wallet'])); ?>"
                           class="nav-link <?php if(request('action') == 'wallet'): ?> active <?php endif; ?>">Wallet</a>
                    </li>
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a data-turbolinks="false"
                           href="<?php echo e(route('client', ['client' => $client, 'action' => 'mailbox'])); ?>"
                           class="nav-link <?php if(request('action') == 'mailbox'): ?> active <?php endif; ?>">Contact Us</a>
                    </li>
                   <!-- <li class="nav-item">
                        <a href="#"
                ...
                <div class="tab-content">
                    <div class="tab-pane active">
                        ...
                        <?php endif; ?>
                           <?php if(request('action') == 'overview'): ?>
                            <?php echo $__env->make('client.overview', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php endif; ?>
                          <?php if(request('action') == 'mailbox'): ?>
                            <?php echo $__env->make('client.mailbox', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php endif; ?>
                        ...
                        <?php endif; ?>
                        <?php if(request('action') == 'wallet'): ?>
                            <?php echo $__env->make('client.wallet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php endif; ?>
                        <?php if(request('action') == 'status'): ?>
                            <?php echo $__env->make('client.status', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php endif; ?>
                     ...
                     <?php if((user()->role =='admin')): ?>
                        ...
                        <?php if(request('action') == 'transactions'): ?>
                            <div class="card">
                              ...
                              <?php $transactions = $client->transactions()->orderByDesc('date')->paginate(1500); ?>
                                    ...
                                    <table id="example" class="table table-striped card-table m-0">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($transaction->type == 'profit'): ?>
                                                    <?php echo e(round($pBalance == 0? 0 : $transaction->amount / $pBalance * 100,2)); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\25-percent\resources\views/client/profile.blade.php ENDPATH**/ ?>