            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="amount" style="font-weight: bolder">
                        <p>
                            Please understand that all deposits are locked in for a 30 day period before being available
                            for withdrawal.
                        </p>
                        Deposits will become active after five working days. 
                        </p>
                      ...
                      <br>
                         ...
                         <label class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="example-checkbox4"
                                   value="option4">
                            <span
                                class="custom-control-label">&nbsp;&nbsp;I agree to a 3.5% fee</span>
                        </label>
                      <!-- f3 end-->
                        ...
                        <p>
                         ...
                         <p>
                            If you need help with the bitcoin transfer please contact: <a
                                href="mailto:support@my-passive-income.net">support@my-passive-income.net</a> for
                            assistance.
                        </p>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="amount" style="font-weight: bolder">
                        <p>
                            ...
                            <p>
At the time of making a withdrawal request the requested amount will be deducted from your live balance and will not generate any more profit. 
<p>
Profits are only generated on your live balance.
<p>
30 days after the request was made you will receive your funds in to the account you specify below.
<p>
   ...
   $('.custom-control-input:checked').each(function(){        
        ...
        final += values;
                  ...
                  var ramount = $("#ramount").val();
                    if (final === 'option2option3option4option5option1' && (ramount>999.9)) {
...
<?php /**PATH /home/paulsclub/public_html/my-passive-income.net/resources/views/client/account.blade.php ENDPATH**/ ?>