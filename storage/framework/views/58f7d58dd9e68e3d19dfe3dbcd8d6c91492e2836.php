        ...
        <nav class="navbar navbar-expand-xl">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav main-menu mx-auto">
              ...
              <li><a href="<?php echo e(url('public/login')); ?>"><b>Login</b></a></li>
          </ul>
          </div>
        </nav>
      </div>
    ...
    <div class="container">
      <div class="row">
          ...
          <div class="counter-area d-flex justify-content-between">
            <div class="counter-item">
              ...
              <div class="counter-content">
                <span class="counter"><?php echo e(number_format($registered_account)); ?></span>
            ...
            <div class="counter-item">
              ...
              <div class="counter-content">
                <span>$</span>
                <span class="counter"><?php echo e(number_format($invested_amoumt,2)); ?></span>
            ...
            <div class="counter-item">
              ...
              <div class="counter-content">
                <span>$</span>
                <span class="counter"><?php echo e(number_format($average_amoumt,2)); ?></span>
        ...
        <div class="col-lg-12 mt-5">
            <h3 class="text-center"><strong>Our AI. (Artificial Intelligence) Trading Program has been online for : <span class="section-subtitle" style="font-size:29px;"><?php echo e($aibot_dates); ?></span> <span style="font-size:28px; color: #ff5500;">Days</span></strong></h3>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="choose-us-slider owl-carousel">
              <div class="choose-item text-center">
                ...
                <div class="choose-content">
                  ...
                  <a href="<?php echo e(url('public/login')); ?>" class="read-more-btn">read more<i class="fa fa-long-arrow-right"></i></a>
                </div>
              </div><!-- choose-item end -->
              <div class="choose-item text-center">
                <div class="choose-thumb">
        ...
        <div class="col-xl-4 offset-md-1 feature-item-wrapper">
          <div class="feature-item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.3s">
            ...
            <div class="content">
              ...
              <a href="<?php echo e(url('public/login')); ?>">get strated</a>
            </div>
          ...
          <div class="feature-item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.5s">
            ...
            <div class="content">
              ...
              <a href="<?php echo e(url('public/login')); ?>">read more</a>
            </div>
          </div><!-- feature-item end -->
          <div class="feature-item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.7s">
            ...
            <div class="content">
              ...
              <a href="<?php echo e(url('public/login')); ?>">explore our investing </a>
            </div>
          </div><!-- feature-item end -->
        </div>
      </div>
          ...
          <div class="offer-slider owl-carousel">
            <div class="offer-item">
              ...
              <div class="content">
                ...
                <a href="<?php echo e(url('public/login')); ?>" class="read-more-btn">read more<i class="icofont-long-arrow-right"></i></a>
              </div>
            </div><!-- offer-item end -->
            <div class="offer-item">
              <div class="icon">
            ...
            <div class="tab-content" id="calculatorTabContent">
              <div class="tab-pane fade show active" id="basic" role="tabpanel" aria-labelledby="basic-tab">
                ...
                <div class="plan-amount-calculate">
                  ...
                  <div class="item">
                    <a href="<?php echo e(url('public/login')); ?>" class="invest-btn btn-round">invest now</a>
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-5">
                ...
                <div class="btn-area text-center">
                  <a href="<?php echo e(url('public/login')); ?>" class="btn btn-secondary">join us</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="deposit-table-area">
                <table>
                  ...
                  <tbody id="tbody_deposit">
                    <?php $__currentLoopData = $deposit_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e($tran->client->firstname . ' ' . $tran->client->lastname); ?></td>
                      <td>$ <?php echo e(number_format($tran->amount, 2)); ?></td>
              ...
              <div class="withdraw-table-area">
                <table>
                  ...
                  <tbody id="tbody_withdraw">
                    <?php $__currentLoopData = $withdraw_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e($tran->client->firstname . ' ' . $tran->client->lastname); ?></td>
                      <td>$ <?php echo e(number_format($tran->amount, 2)); ?></td>
                      <td><?php echo e($tran->created_at); ?></td>
      ...
      <div class="row">
        <div class="col-xl-6">
          <div class="affiliate-features-content text-xl-left text-center">
            ...
            <a href="<?php echo e(url('public/login')); ?>" class="btn btn-primary btn-hover text-small">read more</a>
          </div>
        </div>
        <div class="col-xl-6">
...
<!--  -->
</html><?php /**PATH /home/percen25/public_html/resources/views/index/index.blade.php ENDPATH**/ ?>